...
const SoccerField: React.FC<SoccerFieldProps> = ({ players, onPlayerMove, className }) => {
  ...
  return (
    <div
      className={cn(
        "relative w-full h-96 bg-gradient-to-b from-green-400 to-green-600 rounded-lg overflow-hidden border-2 border-white shadow-lg",
        className
      )}
      onDrop={handleDrop}
